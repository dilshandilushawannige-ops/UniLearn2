...
const UserDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Calculate overall progress from study plans
      ...
      setRecentResources(resourcesData.slice(0, 4)); // Get latest 4
  ...
  // Get upcoming tasks from study plans
      ...
      <main className="dashboard-main">
        ...
        <header className="dashboard-header">
          ...
          <div className="header-actions">
            <Link to="/resources" className="header-link">Archive</Link>
            <Link to="/live-class" className="header-link">Community</Link>
        ...
        <div className="dashboard-content">
          {loading ? (
            ...
            <>
              ...
              <div className="dashboard-grid-top">
                ...
                <div className="card upcoming-tasks-card">
                  <div className="card-header">
                    ...
                    <Link to="/study-plan" className="view-all-link">View All</Link>
                  </div>
                  <div className="tasks-list">
                    {upcomingTasks.length > 0 ? (
                      upcomingTasks.map(task => (
                        <Link to={`/study-plan`} key={task.id} className="task-item">
                ...
                <div className="card recent-resources-card">
                  <div className="card-header">
                    ...
                    <Link to="/resources" className="view-all-link">See New</Link>
                  </div>
                  <div className="resources-list">
                    {recentResources.length > 0 ? (
                      recentResources.map((resource, idx) => (
                        <Link to="/resources" key={resource._id} className="resource-item">
              ...
              {/* Request Status - Only show if user has pending requests */}
                    ...
                    modules.map(module => (
                      <div key={module._id} className="module-card">
                        ...
                        <div className="module-footer">
                          ...
                          <Link 
                            to={`/resources?moduleCode=${module.moduleCode}`} 
